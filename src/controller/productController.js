...
const updateProduct= async (req,res)=>{
  try{
    ...
    let updatedProduct= await  productModel.findOneAndUpdate({_id:productId, isDeleted:false},{updateProductData,$addToSet:{availableSizes:availableSizes}},{new:true})
